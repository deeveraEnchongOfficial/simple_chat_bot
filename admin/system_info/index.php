	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<label for="name" class="control-label">Enable/Disable Chat field</label>
				<div class="input-group mb-3">
					<div class="input-group-prepend">
						<label class="input-group-text" for="inputGroupSelect01">Options</label>
					</div>
					<?php 
					if($_settings->info('isDisable') == 'disabled'){
						$isDisable = 'Disabled';
					}else{
						$isDisable = 'Enable';
					}
					?>
					<select name="isDisable" class="custom-select" id="isDisable">
						<option selected><?php echo $isDisable ?></option>
